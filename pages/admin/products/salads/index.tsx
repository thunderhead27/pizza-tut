...
export default function AdminSalads({ salads }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    const submitHandler: SubmitHandler<FormValues> = async (data) => {
        ...
        axios.post('/api/admin/products/create', newSalad);
                                    ...
                                    <tbody>
                                        {salads.map(el => (
                                            <tr key={el._id}>
                                                ...
                                                <td>${el.price}</td>
                                                <td><button className="bg-cOrange py-2 px-4 rounded-md" onClick={() => router.push(`/admin/products/salads/${el._id}`)}>Edit</button></td>
...
AdminSalads.auth = { adminOnly: true };